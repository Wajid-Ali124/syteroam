...
export default function ManufacturingErpMobileApp() {
  const swiperRef = useRef(null);
  const [openFaq, setOpenFaq] = useState(null);

  const { heroarea, features, howitworks, screenshots, erpWorkflow, faq, preface } = pageData;
  ...
  return (
    <div className="sr-landing-page">
          ...
          <div className="sr-keyfeatures__row sr-keyfeatures__row--center">
            <div className="sr-col sr-col-title">
              <div className="sr-section-title">
                ...
                {features.sectionsubtitle && <p style={{ marginTop: '15px' }}>{features.sectionsubtitle}</p>}
              </div>
            </div>
          </div>
      ...
      {/* NOTE: No Section 5 Data was provided for this page layout so the FeatureOne clone was omitted here */}
          ...
          <div className="sr-preface__content-row flex flex-wrap items-center mx-[-15px] pt-[80px]">
            ...
            <div className="sr-preface__text-col w-full md:w-1/2 px-[15px] md:py-[30px]">
              ...
              <div className="sr-preface__apps flex flex-wrap gap-4 mt-0">
                <Link href={`/${preface.btn1url}`} className="sr-btn sr-btn--filled inline-block pl-[20px] pr-[20px] py-[15px]">
